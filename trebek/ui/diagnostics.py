"""
System diagnostics panel — pre-flight checks for Python, SQLite, FFmpeg,
WhisperX, Gemini API key, and configuration display.

Rendered at startup to give operators immediate visibility into
system readiness before the pipeline begins processing.
"""
