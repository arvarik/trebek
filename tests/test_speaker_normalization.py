...
class TestNormalizeSpeakerNames:
    def test_exact_match(self) -> None:
        ...
        _normalize_speaker_names(
            clues, {}, ["Rachel Bernstein", "Lawrence Subba", "Matt Amodio"]
        )
    ...
    def test_speaker_id_mapping(self) -> None:
        ...
        _normalize_speaker_names(
            clues, mapping, ["Rachel Bernstein", "Lawrence Subba", "Matt Amodio"],
    ...
    def test_ambiguous_name_part_removed(self) -> None:
        ...
        _normalize_speaker_names(
            clues, {}, ["James Smith", "James Johnson", "Matt Amodio"]
        )
    ...
    def test_daily_double_wagerer_normalized(self) -> None:
        ...
        clue = Clue(
            round="Jeopardy", category="Test", board_row=1, board_col=1,
            selection_order=1, is_daily_double=True, requires_visual_context=False,
            host_start_timestamp_ms=0.0, host_finish_timestamp_ms=1000.0,
            clue_syllable_count=5, clue_text="Test clue", correct_response="Test answer",
            daily_double_wager=500, wagerer_name="Rachel",
            attempts=[
                BuzzAttempt(
                    attempt_order=1, speaker="Rachel", response_given="What?",
                    is_correct=True, buzz_timestamp_ms=1500.0, response_start_timestamp_ms=1750.0,
                    is_lockout_inferred=False,
                )
            ],
        )
        _normalize_speaker_names(
            [clue], {}, ["Rachel Bernstein", "Lawrence Subba", "Matt Amodio"]
        )
